...
{
    public class ShowDtailController : Controller
    {
        ...
        public ShowDtailController(UserManager<useraccount> userManager, SignInManager<useraccount> SignInManager, IConfiguration config, ApplicationDbContext context)
        {
