...
{
   // [Authorize(Roles = "SuperAdmin,HOD,ED,Director")]
    public class DirectorController : Controller
    {
        ...
        public DirectorController(UserManager<useraccount> userManager, SignInManager<useraccount> SignInManager, IConfiguration config, ApplicationDbContext context)
        {
        ...
        public IActionResult Index()
        {
            ...
            var box = (from s in _context.Box where s.ReceiverID1 == usId && s.Status1 == "Waiting" orderby s.Id descending select s);
